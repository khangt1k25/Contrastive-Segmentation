...
class MyAugmentation(nn.Module):
    def __init__(self):
        ...
        self.randAffine = K.augmentation.RandomAffine([-45., 45.], [0., 0.15], [0.5, 1.5], [0., 0.15], p=0., same_on_batch=True, return_transform=True)
        self.normalize = K.augmentation.Normalize(mean=[0.485, 0.456, 0.406],
