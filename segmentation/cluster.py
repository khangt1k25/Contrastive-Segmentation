...
from utils.common_config import get_val_dataset, get_val_transformations,\
                                get_val_dataloader,\
                                get_model
from utils.cluster_utils import save_embeddings_to_disk, eval_cluster
...
def main():
    ...
    # Kmeans Clustering
    n_clusters= 21
    save_embeddings_to_disk(p, val_dataloader, model, n_clusters=n_clusters, seed=1234)
    eval_stats, match = eval_cluster(p, true_val_dataset, n_clusters=n_clusters, verbose=True)
